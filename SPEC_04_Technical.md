...
| `AutoMfgReviveSpawnOffsetYPx` | 自动制造复活出生上偏移 | `400` | 问号/士兵出生相对堆底向上像素 |
...
| `AutoMfgSoldierShadowWidthPx` | 自动制造士兵影子宽 | `20` | 复活件脚下椭圆影子宽（参考像素 / sizeDelta） |
| `AutoMfgSoldierShadowHeightPx` | 自动制造士兵影子高 | `8` | 复活件脚下椭圆影子高（参考像素 / sizeDelta） |
| `AutoMfgSoldierShadowAlpha` | 自动制造士兵影子透明度 | `0.45` | 脚下影子黑色 Alpha（0～1） |
...
| `AutoMfgReviveSpawnOffsetYPx` | 自动制造复活出生上偏移 | `400` | Mystery/soldier spawn Y above pile base (px) |
...
| `AutoMfgSoldierShadowWidthPx` | 自动制造士兵影子宽 | `20` | Oval foot-shadow width (ref px / sizeDelta) |
| `AutoMfgSoldierShadowHeightPx` | 自动制造士兵影子高 | `8` | Oval foot-shadow height (ref px / sizeDelta) |
| `AutoMfgSoldierShadowAlpha` | 自动制造士兵影子透明度 | `0.45` | Foot-shadow black Alpha (0–1) |
