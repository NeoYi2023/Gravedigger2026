...
namespace Gravedigger2026.Core.Level
{
    ...
    /// Leave → UI-017 victory → onVictoryAdvance (TryAdvanceStage). SE-09 wires loyal wipe →
    /// UI-017 defeat → onFailureReturnTitle / onFailureRestart. Does not modify PushMapSessionService.
    /// </summary>
