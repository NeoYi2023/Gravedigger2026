...
namespace Gravedigger2026.Core.UpgradeManufacture
{
    ...
    public sealed class ManufactureService
    {
        ...
        /// SoldierSkills / VisualStyle* / VisualModelScale (must not clear baked skills or visual style).
        /// </summary>
        ...
        private bool TryApplyRecipeStatSnapshot(WarriorInstance warrior)
        {
            ...
            // SoldierSkills / VisualStyle / VisualModelScale: leave as loaded. Repair must not clear.
