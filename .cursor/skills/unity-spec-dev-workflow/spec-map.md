...
| 挖坟 Dig / DigMap / Grave | [§3.10](../../SPEC_03_GameRules.md) | [§9.2](../../SPEC_04_Technical.md) DigMapId→`Prefabs/Maps/Ground_*`；镜头迷雾 `CameraFogOverlay`←`Art/Maps/Fog_1.png`；[§13](../../SPEC_04_Technical.md)（含 FlowingWater 两层 Tilemap、MapAutoTile / Isometric Rule Tile）；[§15](../../SPEC_04_Technical.md) Digger 烘焙整角 |
