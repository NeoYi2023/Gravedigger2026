...
| Mode2 自动制造 AutoManufacture | [§3.15](../../SPEC_03_GameRules.md) | [§9.9b](../../SPEC_04_Technical.md) ClassConfig（AttackMode/PlacementOrder/DefaultAppearanceId/DefaultSkillIds）；[§9.12](../../SPEC_04_Technical.md) BodyPart 扩列；[§9.24](../../SPEC_04_Technical.md) MagicBookConfig（含 SoldierSkillLevelAdd / ForceClass 职业进阶）；[§13](../../SPEC_04_Technical.md) FormationClassZone（IsoDiamond，同 WalkSurface）；[§6](../../SPEC_04_Technical.md) AutoManufactureBatch；UI-015 / D-054 制造记录；UI-016 / D-055 演出；issues `.scratch/mode2-auto-manufacture/`；职业区改形 `.scratch/formation-class-zone-isodiamond/` |
| 主角装备 ProtagonistEquipment | [§3.16](../../SPEC_03_GameRules.md) | [§9.25](../../SPEC_04_Technical.md) ProtagonistEquipmentConfig；[§9.6](../../SPEC_04_Technical.md) Dig caps 与科技加法；[§6](../../SPEC_04_Technical.md) EquipCommonExp / ProtagonistEquipmentWarehouse 持久化意图 |
| 士兵属性构成 | [§3.11](../../SPEC_03_GameRules.md) 士兵属性构成 | [§9.9](../../SPEC_04_Technical.md)–[§9.15](../../SPEC_04_Technical.md)；Base(S)=Σ StatBonus；StaticStat / FinalStat；ClassId→ClassConfig（PrimaryStat；CombatConvertCoeffs；AttackRange；DefaultSkillIds）；MaxHP=ceil(BodyLife+Str×3)；多宝石 Σ GemMult；SoldierSkills |
...
| 士兵技能 SoldierSkill | [§3.11](../../SPEC_03_GameRules.md) 士兵技能授予、[§3.15](../../SPEC_03_GameRules.md) DefaultSkillIds / SoldierSkillLevelAdd | [§9.9](../../SPEC_04_Technical.md) WarriorInstance.SoldierSkills；[§9.9b](../../SPEC_04_Technical.md) DefaultSkillIds；[§9.21](../../SPEC_04_Technical.md) SkillConfig；[§9.21b](../../SPEC_04_Technical.md) SkillEffectConfig；[§9.24](../../SPEC_04_Technical.md) SoldierSkillLevelAdd；Demo 不施放 |
