...
| 关卡阶段流水线 / LevelOperation / RouteSelect | [§3.9](../../SPEC_03_GameRules.md) UI-031 / D-086 | [§9.1](../../SPEC_04_Technical.md) / [§9.31](../../SPEC_04_Technical.md)；Prefab `LevelRouteSelectRoot` |
...
| 搜打撤 SearchExtract | [§3.19](../../SPEC_03_GameRules.md) | [§9.31](../../SPEC_04_Technical.md) `GatherPointCount`/`GatherPointRewards`；[§9.32～§9.33](../../SPEC_04_Technical.md)；样例图 `SearchExtract_Demo_01`（SE-02 方案 B）；`SearchExtractStageModule` **SE-03～SE-09 已落地**（含全灭 AbortLevel）；issues `.scratch/mode3-search-extract/` |
