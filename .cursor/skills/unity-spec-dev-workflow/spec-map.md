...
| 关卡阶段流水线 / LevelOperation / DifficultyConfig / RouteSelect | [§3.9](../../SPEC_03_GameRules.md) UI-031 / D-086 / D-088；难度表解锁/通关奖（Hub 接线后置） | [§9.1](../../SPEC_04_Technical.md) / [§9.1a](../../SPEC_04_Technical.md) / [§9.31](../../SPEC_04_Technical.md)；壳 `LevelRouteSelectRoot` + 每关 `LevelRouteMap_{LevelId}`；路线进度 `LevelRouteProgress` |
...
| 战术阵型 TacticalFormation | [§3.18](../../SPEC_03_GameRules.md) | [§9.30](../../SPEC_04_Technical.md) TacticalFormationConfig；GrantFormationSkill；Pattern Prefab；虚拟中心+FormationSlot+leash；PushMap/Defend Stage 分流 **TF-04b 已落地**；激活/解散 overlay **TF-05 已落地**；样例+手验 **TF-06 已落地**；issues `.scratch/tactical-formation/` |
| 搜打撤 SearchExtract | [§3.19](../../SPEC_03_GameRules.md) | [§9.31](../../SPEC_04_Technical.md) `GatherPointCount`/`GatherPointRewards`；[§9.32～§9.33](../../SPEC_04_Technical.md)；样例图 `SearchExtract_Demo_01`（SE-02 方案 B）；`SearchExtractStageModule` **SE-03～SE-09 已落地**（含全灭 AbortLevel）；D-074 怪物死亡技能经共享 `IMonsterDeathSkillHost`；**P1 HoldFraming SE-CAM-00～03 已关**（样例锁定初值；issues `.scratch/search-extract-hold-camera/`）；issues `.scratch/mode3-search-extract/` |
