...
| Mode2 自动制造 AutoManufacture | [§3.15](../../SPEC_03_GameRules.md) | [§9.9b](../../SPEC_04_Technical.md) ClassConfig（AttackMode/PlacementOrder/DefaultAppearanceId/DefaultSkillIds）；[§9.12](../../SPEC_04_Technical.md) BodyPart 扩列；[§9.24](../../SPEC_04_Technical.md) MagicBookConfig（含 SoldierSkillLevelAdd / ForceClass / VisualStyle 列）；[§15.2](../../SPEC_04_Technical.md) AllIn1 VisualStyle Catalog；[§13](../../SPEC_04_Technical.md) FormationClassZone（IsoDiamond，同 WalkSurface）；[§6](../../SPEC_04_Technical.md) AutoManufactureBatch；UI-015 / D-054 制造记录；UI-016 / D-055 演出；issues `.scratch/mode2-auto-manufacture/`；职业区改形 `.scratch/formation-class-zone-isodiamond/` |
