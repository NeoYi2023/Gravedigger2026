...
| 主角装备 ProtagonistEquipment | [§3.16](../../SPEC_03_GameRules.md) | [§9.25](../../SPEC_04_Technical.md) ProtagonistEquipmentConfig；[§9.6](../../SPEC_04_Technical.md) Dig caps 与科技加法；Dig 事件 Token `DigOnGraveClear` / `Explosive*`（D-077）、`DigLightning*`（D-078 `Equip_Elctr`）；静态键 `DigProcessSpawnCountBonus`（D-079 `Equip_Detector`）；[§6](../../SPEC_04_Technical.md) EquipCommonExp / ProtagonistEquipmentWarehouse 持久化意图；UI-022 / D-067 仓只读弹窗 |
