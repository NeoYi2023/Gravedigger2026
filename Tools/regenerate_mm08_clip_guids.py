#!/usr/bin/env python3
"""Assign fresh Unity guids to MonsterModel_08 Animation Clips (avoid MM05 duplicates)."""
...
CLIPS = ROOT / "Assets/Art/Characters/Monsters/MonsterModel_08/Animation Clips"
