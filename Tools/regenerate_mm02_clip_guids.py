#!/usr/bin/env python3
"""Assign fresh Unity guids to MonsterModel_02 Animation Clips (avoid MM05 duplicates)."""
...
CLIPS = ROOT / "Assets/Art/Characters/Monsters/MonsterModel_02/Animation Clips"
